...
//                        $facevalues[0].click();
            ...
            $("#btnPost").on("click", function () {
                // 如果验证通过
                if($("#cardForm").valid()){
                    $.post("/card/postCards", $('#cardForm').serializeArray(), function (json) {
                        // 成功
    ...
    <div class="content">
        <div class="accInfo submitInfo w1200 clearfix">
            ...
            <div class="submitRight">
                ...
                <div class="subm">
                    <a href="/card/single" >单张提交</a>
                    <a href="/card/batch" class="current">批量提交</a></div>
                <div class="submCon02 submCon">
                    ...
                    <p>
                        <label for="">请输入卡号及卡密：</label>
                        <textarea cols="50" rows="10" name="cardcontent"  id="cardcontent" class="input-xlarge input-t" placeholder="批量卡密" required></textarea>
                        <%--<textarea name="" id="" cols="50" rows="10"></textarea>--%>
                        <span class="gray">说明：卡号和卡密必须在同一行，卡号和卡密之间用“,”或“”隔开。每张卡换行！一次最多只能输入10张卡。格式如下：
                        <br/>1234567890,123456<br/>1234567890 123456</span>
                    </p>
                    <p>
                        <label for="">验证码：</label>
